...
fun getAppTypography(lang: AppLanguage): Typography {
    val fontFamily = if (lang == AppLanguage.EN) OpenSansFont else VazirmatnFont
...
val Typography = getAppTypography(AppLanguage.EN)
